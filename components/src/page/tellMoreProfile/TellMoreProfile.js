...
export default function TellMoreProfile() {
  return (
    ...
    />
      ...
      <View style={{marginTop:32}}>
        <Text style={{fontSize:24,textAlign:'center',fontFamily:'Manrope'}}>tell us more</Text>
         ...
         <View style={{borderColor:"#FEC946",justifyContent:'center',alignSelf:'center',marginTop:26,width:128,height:128,borderRadius:62,borderWidth:1}}>
            <Image source={Images['profile']} style={{width:120,height:120,borderRadius:50,alignSelf:'center'}} resizeMode='contain'/>
            </View>
